...
class Win2:
    ...
    def create_widgets(self):
        ...
        resized = image.resize((512, 290), Image.Resampling.LANCZOS)
        photo = ImageTk.PhotoImage(resized)
...
class Win3:
    ...
    def create_widgets(self):
        ...
        resized = image.resize((190, 280), Image.Resampling.LANCZOS)
        photo = ImageTk.PhotoImage(resized)
...
class Win4:
    ...
    def create_widgets(self):
        ...
        resized = image.resize((650, 433), Image.Resampling.LANCZOS)
        photo = ImageTk.PhotoImage(resized)
